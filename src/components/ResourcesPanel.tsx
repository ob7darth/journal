...
import { ExternalLink, Book, GraduationCap, ShoppingCart, Heart, Users, Database } from 'lucide-react';
import BibleDataManager from './BibleDataManager';

const ResourcesPanel: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'resources' | 'bible-data'>('resources');
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex bg-white rounded-lg p-1 shadow-sm">
        ...
        <button
          onClick={() => setActiveTab('bible-data')}
          className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-md transition-colors ${
            activeTab === 'bible-data' 
              ? 'bg-primary-600 text-white' 
              : 'text-gray-600 hover:text-gray-800'
          }`}
        >
